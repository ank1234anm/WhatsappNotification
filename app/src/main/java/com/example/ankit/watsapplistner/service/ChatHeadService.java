...
import com.example.ankit.watsapplistner.activity.MainActivity;
...
public class ChatHeadService extends Service {
    ...
    public void onCreate() {
        ...
        RelativeLayout chat_head_root = (RelativeLayout) mChatHeadView.findViewById(R.id.chat_head_root);
        chat_head_root.setOnClickListener(new View.OnClickListener() {
            @Override
